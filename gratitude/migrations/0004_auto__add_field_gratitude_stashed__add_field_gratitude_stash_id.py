...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gratitude.stashed'
        db.add_column('gratitude_gratitude', 'stashed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Gratitude.stash_id'
        db.add_column('gratitude_gratitude', 'stash_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gratitude.stashed'
        db.delete_column('gratitude_gratitude', 'stashed')

        # Deleting field 'Gratitude.stash_id'
        db.delete_column('gratitude_gratitude', 'stash_id')
