...
appConfigFile = '/opt/gratitude-test/gratitude.config'
...
STATIC_ROOT = '/opt/gratitude-test/gratitude/static'
STATIC_URL = '/app/static/'
LOGFILE_PATH = '/opt/gratitude-test/logs/gratitude.log'
...
SOCIAL_AUTH_INACTIVE_USER_URL = SITE_PREFIX + SOCIAL_AUTH_INACTIVE_USER_BASE_URL

# Gratitude settings
DJANGO_PROCESS_NAME = 'manage.py run_gunicorn'
