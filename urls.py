...
urlpatterns = patterns('',
   ...
   url(r'^congratulations',
       direct_to_template,
       {'template': 'gratitude/congratulations.html'},
       name='gratitude_congratulations'),
   url(r'^message',
       direct_to_template,
       {'template': 'gratitude/blank.html'},
       name='gratitude_message'),
   url(r'^thankyou', 'gratitude.gratitude.views.thankyou', name='gratitude_thankyou'), 
