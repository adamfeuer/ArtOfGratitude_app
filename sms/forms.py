...
class SurveysForm(forms.Form):
   ...
   no_messages = forms.BooleanField(required=False, label=_('Do not send me any further text messages or emails'), help_text='If you want to stop receiving email from us, check this box.')
